...
//       chart.allLabels[1].text = date.format("MMMM"); //get the full month name
//       chart.allLabels[0].text = date.format("Do"); //get date with ordinal
//     }
